    ...
    paymentModal.querySelector('.modal-content').innerHTML = `
        ...
        <div class="payment-methods">
            <div class="payment-option">
                <img src="https://upload.wikimedia.org/wikipedia/commons/6/64/Easypaisa_logo.png" alt="EasyPaisa" class="payment-logo">
                <h3>EasyPaisa</h3>
            ...
            <div class="payment-option">
                <img src="https://upload.wikimedia.org/wikipedia/commons/4/4e/Binance_Logo.png" alt="Binance" class="payment-logo">
                <h3>Binance</h3>
...
console.log('ZAIN X CHEAT - Streamer Panel initialized successfully!');
